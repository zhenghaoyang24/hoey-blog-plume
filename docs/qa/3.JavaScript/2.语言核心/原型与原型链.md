---
title: 原型与原型链
createTime: 2026/03/31 15:07:23
permalink: /qa/js/u9xipw6o/
---

<Question :questions="['原型是什么？','获取原型的方法？','原型链是什么？']" />
...
[编码与实现-函数的this](/qa/js/vow22uke/)，
[编码与实现-函数的方法](/qa/js/c2f82i9i/)，
[编码与实现-函数的方法2](/qa/js/ao9zem68/)
