...
permalink: /qa/basic/javascript/zo3adust/
outline: 2
---

## 函数定义

<Question :questions="['定义函数有哪些方法，它们有什么区别？']" />
...
<Question :questions="['什么是闭包？','闭包的作用是什么？']" />
...
<JSRunner :code='code2' height='300' />
