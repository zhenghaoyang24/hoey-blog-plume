<template><div><p>在 JavaScript 中，有多种变量声明方式，主要包括使用 <code v-pre>var</code>、<code v-pre>let</code>、<code v-pre>const</code> 关键字，以及函数声明、类声明等，下面详细介绍它们及其区别。</p>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-函数声明" tabindex="-1"><a class="header-anchor" href="#_4-函数声明"><span>4. 函数声明</span></a></h3>
<ul>
<li><strong>特点</strong>
<ul>
<li><strong>函数作用域</strong>：函数声明创建的函数具有函数作用域。</li>
<li><strong>函数提升</strong>：函数声明会被提升到当前作用域的顶部，可以在声明之前调用函数。</li>
</ul>
</li>
<li><strong>示例代码</strong></li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="javascript" data-title="javascript"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#59873A;--shiki-dark:#80A665">sayHello</span><span style="--shiki-light:#999999;--shiki-dark:#666666">();</span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD"> // 可以在声明之前调用</span></span>
<span class="line"><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">function</span><span style="--shiki-light:#59873A;--shiki-dark:#80A665"> sayHello</span><span style="--shiki-light:#999999;--shiki-dark:#666666">()</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> {</span></span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_5-类声明" tabindex="-1"><a class="header-anchor" href="#_5-类声明"><span>5. 类声明</span></a></h3>
<ul>
<li><strong>特点</strong>
<ul>
<li><strong>块级作用域</strong>：类声明具有块级作用域。</li>
<li><strong>不存在提升</strong>：类声明不会被提升，在声明之前使用类会导致 <code v-pre>ReferenceError</code>。</li>
</ul>
</li>
<li><strong>示例代码</strong></li>
</ul>
<div class="language-javascript line-numbers-mode" data-ext="javascript" data-title="javascript"><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code" v-pre=""><code><span class="line"><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD">// const myClass = new MyClass(); // 报错: ReferenceError: Cannot access 'MyClass' before initialization</span></span>
...
<span class="line"><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A">        console</span><span style="--shiki-light:#999999;--shiki-dark:#666666">.</span><span style="--shiki-light:#59873A;--shiki-dark:#80A665">log</span><span style="--shiki-light:#999999;--shiki-dark:#666666">(</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77">'</span><span style="--shiki-light:#B56959;--shiki-dark:#C98A7D">MyClass instance created</span><span style="--shiki-light:#B5695977;--shiki-dark:#C98A7D77">'</span><span style="--shiki-light:#999999;--shiki-dark:#666666">);</span></span>
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666">    }</span></span>
<span class="line"><span style="--shiki-light:#999999;--shiki-dark:#666666">}</span></span>
<span class="line"><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676">const</span><span style="--shiki-light:#B07D48;--shiki-dark:#BD976A"> myClass</span><span style="--shiki-light:#999999;--shiki-dark:#666666"> =</span><span style="--shiki-light:#AB5959;--shiki-dark:#CB7676"> new</span><span style="--shiki-light:#59873A;--shiki-dark:#80A665"> MyClass</span><span style="--shiki-light:#999999;--shiki-dark:#666666">();</span><span style="--shiki-light:#A0ADA0;--shiki-dark:#758575DD"> // 可以正常创建实例</span></span></code></pre>
...
<p>在实际开发中，建议优先使用 <code v-pre>const</code> 声明常量，当需要重新赋值时使用 <code v-pre>let</code>，尽量避免使用 <code v-pre>var</code> 以减少潜在的问题。函数和类的声明则根据具体需求进行使用。</p>
</div></template>
