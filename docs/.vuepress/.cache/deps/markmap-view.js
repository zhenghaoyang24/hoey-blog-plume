...
// node_modules/.pnpm/markmap-view@0.18.10_markmap-common@0.18.9/node_modules/markmap-view/dist/index.js
var Z = typeof navigator < "u" && navigator.userAgent.includes("Macintosh");
var bt = ordinal(category10_default);
var q = (e = 1, t = 3, i = 2) => (n) => e + t / i ** n.state.depth;
var J = {
  autoFit: false,
  duration: 500,
  embedGlobalCSS: true,
...
function ke(e) {
  const t = {}, i = { ...e }, { color: n, colorFreezeLevel: s2, lineWidth: a2 } = i;
  ...
  if (s2) {
    ...
    t.color = (h) => (h = {
      ...
      state: {
        ...h.state,
        path: h.state.path.split(".").slice(0, s2).join(".")
      }
    }, l(h));
  }
  if (a2) {
    const l = Array.isArray(a2) ? a2 : [a2, 0, 1];
    t.lineWidth = q(
      ...l
    );
  }
...
function Ct(e) {
  var t = this, i, n = [t], s2, a2, c3;
  do
    for (i = n.reverse(), n = []; t = i.pop(); )
      if (e(t), s2 = t.children, s2) for (a2 = 0, c3 = s2.length; a2 < c3; ++a2)
        n.push(s2[a2]);
  while (n.length);
  return this;
}
...
function Rt(e) {
  for (var t = this, i = [t], n = [], s2, a2, c3; t = i.pop(); )
    if (n.push(t), s2 = t.children, s2) for (a2 = 0, c3 = s2.length; a2 < c3; ++a2)
      i.push(s2[a2]);
  for (; t = n.pop(); )
    e(t);
  return this;
...
function H(e, t) {
  var i = new j(e), n = +e.value && (i.value = e.value), s2, a2 = [i], c3, o, l, h;
  for (t == null && (t = Ft); s2 = a2.pop(); )
    if (n && (s2.value = +s2.data.value), (o = t(s2.data)) && (h = o.length))
      for (s2.children = new Array(h), l = h - 1; l >= 0; --l)
        a2.push(c3 = s2.children[l] = new j(o[l])), c3.parent = s2, c3.depth = s2.depth + 1;
...
var $t = "d3-flextree";
var Nt = "2.1.2";
var Wt = "build/d3-flextree.js";
var It = "index";
var Pt = { name: "Chris Maloney", url: "http://chrismaloney.org" };
var Kt = "Flexible tree layout algorithm that allows for variable node sizes.";
var Gt = ["d3", "d3-module", "layout", "tree", "hierarchy", "d3-hierarchy", "plugin", "d3-plugin", "infovis", "visualization", "2d"];
var Vt = "https://github.com/klortho/d3-flextree";
var Ut = "WTFPL";
var Yt = { type: "git", url: "https://github.com/klortho/d3-flextree.git" };
var Zt = { clean: "rm -rf build demo test", "build:demo": "rollup -c --environment BUILD:demo", "build:dev": "rollup -c --environment BUILD:dev", "build:prod": "rollup -c --environment BUILD:prod", "build:test": "rollup -c --environment BUILD:test", build: "rollup -c", lint: "eslint index.js src", "test:main": "node test/bundle.js", "test:browser": "node test/browser-tests.js", test: "npm-run-all test:*", prepare: "npm-run-all clean build lint test" };
var qt = { "d3-hierarchy": "^1.1.5" };
var Jt = { "babel-plugin-external-helpers": "^6.22.0", "babel-preset-es2015-rollup": "^3.0.0", d3: "^4.13.0", "d3-selection-multi": "^1.0.1", eslint: "^4.19.1", jsdom: "^11.6.2", "npm-run-all": "^4.1.2", rollup: "^0.55.3", "rollup-plugin-babel": "^2.7.1", "rollup-plugin-commonjs": "^8.0.2", "rollup-plugin-copy": "^0.2.3", "rollup-plugin-json": "^2.3.0", "rollup-plugin-node-resolve": "^3.0.2", "rollup-plugin-uglify": "^3.0.0", "uglify-es": "^3.3.9" };
var Qt = {
  name: $t,
  version: Nt,
  main: Wt,
...
function tt(e) {
  ...
  function s2() {
    ...
    return class Q extends H.prototype.constructor {
      ...
      copy() {
        const d = c3(this.constructor, this, (g) => g.children);
  ...
  function a2() {
    const o = s2(), l = i("nodeSize"), h = i("spacing");
  ...
  function c3(o, l, h) {
    const d = (g, u4) => {
      ...
      Object.assign(m, {
        parent: u4,
        depth: u4 === null ? 0 : u4.depth + 1,
        height: 0,
        length: 1
      });
      const x3 = h(g) || [];
      return m.children = x3.length === 0 ? null : x3.map((y3) => d(y3, m)), m.children && Object.assign(m, m.children.reduce(
        (y3, k2) => ({
  ...
  return Object.assign(n, {
    ...
    dump(o) {
      const l = i("nodeSize"), h = (d) => (g) => {
        const u4 = d + "  ", m = d + "    ", { x: x3, y: y3 } = g, k2 = l(g), b = g.children || [], z = b.length === 0 ? " " : `,${u4}children: [${m}${b.map(h(m)).join(m)}${u4}],${d}`;
        return `{ size: [${k2.join(", ")}],${u4}x: ${x3}, y: ${y3}${z}},`;
      };
      return h(`
`)(o);
    }
...
var et = (e, t = 0) => (e.y = t, (e.children || []).reduce((i, n) => {
  const [s2, a2] = i;
  et(n, e.y + e.ySize);
  const c3 = (s2 === 0 ? n.lExt : n.rExt).bottom;
  s2 !== 0 && ne(e, s2, a2);
  const o = de2(c3, s2, a2);
  return [s2 + 1, o];
}, [0, null]), re2(e), he(e), e);
var rt = (e, t, i) => {
...
var re2 = (e) => {
  (e.children || []).reduce((t, i) => {
    const [n, s2] = t, a2 = n + i.shift, c3 = s2 + a2 + i.change;
    return i.relX += c3, [a2, c3];
  }, [0, 0]);
};
var ne = (e, t, i) => {
  const n = e.children[t - 1], s2 = e.children[t];
  let a2 = n, c3 = n.relX, o = s2, l = s2.relX, h = true;
  for (; a2 && o; ) {
    a2.bottom > i.lowY && (i = i.next);
    const d = c3 + a2.prelim - (l + o.prelim) + a2.xSize / 2 + o.xSize / 2 + a2.spacing(o);
    (d > 0 || d < 0 && h) && (l += d, ie(s2, d), se(e, t, i.index, d)), h = false;
    const g = a2.bottom, u4 = o.bottom;
    g <= u4 && (a2 = ae(a2), a2 && (c3 += a2.relX)), g >= u4 && (o = oe(o), o && (l += o.relX));
  }
  !a2 && o ? le(e, t, o, l) : a2 && !o && ce2(e, t, a2, c3);
};
var ie = (e, t) => {
  e.relX += t, e.lExtRelX += t, e.rExtRelX += t;
};
var se = (e, t, i, n) => {
  const s2 = e.children[t], a2 = t - i;
  if (a2 > 1) {
    const c3 = n / a2;
    e.children[i + 1].shift += c3, s2.shift -= c3, s2.change -= n - c3;
  }
};
var oe = (e) => e.hasChildren ? e.firstChild : e.lThr;
var ae = (e) => e.hasChildren ? e.lastChild : e.rThr;
var le = (e, t, i, n) => {
  const s2 = e.firstChild, a2 = s2.lExt, c3 = e.children[t];
  a2.lThr = i;
  const o = n - i.relX - s2.lExtRelX;
  a2.relX += o, a2.prelim -= o, s2.lExt = c3.lExt, s2.lExtRelX = c3.lExtRelX;
};
var ce2 = (e, t, i, n) => {
  const s2 = e.children[t], a2 = s2.rExt, c3 = e.children[t - 1];
  a2.rThr = i;
  const o = n - i.relX - s2.rExtRelX;
  a2.relX += o, a2.prelim -= o, s2.rExt = c3.rExt, s2.rExtRelX = c3.rExtRelX;
};
var he = (e) => {
  if (e.hasChildren) {
...
var pe = "path.markmap-link";
var ge = "g.markmap-highlight";
var A5 = linkHorizontal();
function U(e, t) {
...
var it = class _it {
  constructor(t, i) {
    this.options = { ...J }, this._disposeList = [], this.handleZoom = (n) => {
      ...
      n.preventDefault();
      const s2 = transform(this.svg.node()), a2 = s2.translate(
        -n.deltaX / s2.k,
        -n.deltaY / s2.k
      );
      ...
      (Z ? n.metaKey : n.ctrlKey) && (a2 = !a2), this.toggleNode(s2, a2);
...
`);
  ...
  _initializeData(t) {
    ...
    let a2 = 0, c3 = 0;
    return walkTree(t, (o, l, h) => {
      var g, u4, m, x3;
      c3 += 1, o.children = (g = o.children) == null ? void 0 : g.map((y3) => ({ ...y3 })), i += 1, o.state = {
        ...o.state,
        depth: c3,
        id: i,
        rect: {
        ...
        size: [0, 0]
      }, o.state.key = [(u4 = h == null ? void 0 : h.state) == null ? void 0 : u4.id, o.state.id].filter(Boolean).join(".") + Et(o.content), o.state.path = [(m = h == null ? void 0 : h.state) == null ? void 0 : m.path, o.state.id].filter(Boolean).join("."), n(o);
      const d = ((x3 = o.payload) == null ? void 0 : x3.fold) === 2;
      d ? a2 += 1 : (a2 || s2 >= 0 && o.state.depth >= s2) && (o.payload = { ...o.payload, fold: 1 }), l(), d && (a2 -= 1), c3 -= 1;
    }), t;
  }
  _relayout() {
    ...
    const { lineWidth: t, paddingX: i, spacingHorizontal: n, spacingVertical: s2 } = this.options, a2 = tt({}).children((l) => {
      var h;
      if (!((h = l.payload) != null && h.fold)) return l.children;
    }).nodeSize((l) => {
      const [h, d] = l.data.state.size;
      return [d, h + (h ? i * 2 : 0) + n];
    }).spacing((l, h) => (l.parent === h.parent ? s2 : s2 * 2) + t(l.data)), c3 = a2.hierarchy(this.state.data);
    a2(c3);
    const o = c3.descendants();
    o.forEach((l) => {
      const h = l.data;
      h.state.rect = {
        x: l.y,
      ...
      x1: min(o, (l) => l.data.state.rect.x) || 0,
      y1: min(o, (l) => l.data.state.rect.y) || 0,
      x2: max(
        o,
  ...
  _getHighlightRect(t) {
    const i = this.svg.node(), s2 = 4 / transform(i).k, a2 = {
      ...t.state.rect
    };
    return a2.x -= s2, a2.y -= s2, a2.width += 2 * s2, a2.height += 2 * s2, a2;
  }
  async renderData(t) {
    const { paddingX: i, autoFit: n, color: s2, maxWidth: a2, lineWidth: c3 } = this.options, o = this.state.data;
    if (!o) return;
    const l = {}, h = {}, d = [];
    walkTree(o, (r, p, f) => {
      var E2;
      (E2 = r.payload) != null && E2.fold || p(), l[r.state.id] = r, f && (h[r.state.id] = f.state.id), d.push(r);
    });
    const g = {}, u4 = {}, m = (r) => {
      !r || g[r.state.id] || walkTree(r, (p, f) => {
        g[p.state.id] = r.state.id, f();
      });
    }, x3 = (r) => u4[g[r.state.id]] || o.state.rect, y3 = (r) => (l[g[r.state.id]] || o).state.rect;
    u4[o.state.id] = o.state.rect, t && m(t);
    let { highlight: k2 } = this.state;
    k2 && !l[k2.state.id] && (k2 = void 0);
    let b = this.g.selectAll(v2(ge)).selectAll(v2("rect")).data(k2 ? [this._getHighlightRect(k2)] : []).join("rect").attr("x", (r) => r.x).attr("y", (r) => r.y).attr("width", (r) => r.width).attr("height", (r) => r.height);
    const z = this.g.selectAll(v2(M2)).each((r) => {
      u4[r.state.id] = r.state.rect;
    }).data(d, (r) => r.state.key), B3 = z.enter().append("g").attr("data-depth", (r) => r.state.depth).attr("data-path", (r) => r.state.path).each((r) => {
      m(l[h[r.state.id]]);
    }), C3 = z.exit().each((r) => {
      m(l[h[r.state.id]]);
    }), S = z.merge(B3).attr(
    ...
    ), F = S.selectAll(v2("line")).data(
      (r) => [r],
      (r) => r.state.key
    ), L = F.enter().append("line").attr("stroke", (r) => s2(r)).attr("stroke-width", 0), D3 = F.merge(L), $ = S.selectAll(v2("circle")).data(
      (r) => {
        var p;
        return (p = r.children) != null && p.length ? [r] : [];
      },
      (r) => r.state.key
    ), N = $.enter().append("circle").attr("stroke-width", 0).attr("r", 0).on("click", (r, p) => this.handleClick(r, p)).on("mousedown", T).merge($).attr("stroke", (r) => s2(r)).attr(
      "fill",
      (r) => {
        var p;
        return (p = r.payload) != null && p.fold && r.children ? s2(r) : "var(--markmap-circle-open-bg)";
      }
    ), W = this._observer, I = S.selectAll(v2("foreignObject")).data(
      (r) => [r],
      (r) => r.state.key
    ...
    const K2 = _.merge(I), st = d.flatMap(
      (r) => {
        var p;
        return (p = r.payload) != null && p.fold ? [] : r.children.map((f) => ({ source: r, target: f }));
      }
    ), O = this.g.selectAll(v2(pe)).data(st, (r) => r.target.state.key), ot = O.exit(), at = O.enter().insert("path", "g").attr("class", "markmap-link").attr("data-depth", (r) => r.target.state.depth).attr("data-path", (r) => r.target.state.path).attr("d", (r) => {
      const p = x3(r.target), f = [
        p.x + p.width,
        p.y + p.height
      ];
      return A5({ source: f, target: f });
    }).attr("stroke-width", 0).merge(O);
    this.svg.style(
      "--markmap-max-width",
      a2 ? `${a2}px` : null
    ), await new Promise(requestAnimationFrame), this._relayout(), b = b.data(k2 ? [this._getHighlightRect(k2)] : []).join("rect"), this.transition(b).attr("x", (r) => r.x).attr("y", (r) => r.y).attr("width", (r) => r.width).attr("height", (r) => r.height), B3.attr("transform", (r) => {
      const p = x3(r);
      return `translate(${p.x + p.width - r.state.rect.width},${p.y + p.height - r.state.rect.height})`;
    }), this.transition(C3).attr("transform", (r) => {
      const p = y3(r), f = p.x + p.width - r.state.rect.width, E2 = p.y + p.height - r.state.rect.height;
      return `translate(${f},${E2})`;
    }).remove(), this.transition(S).attr(
      "transform",
      (r) => `translate(${r.state.rect.x},${r.state.rect.y})`
    );
    const lt = C3.selectAll(
      v2("line")
    );
    this.transition(lt).attr("x1", (r) => r.state.rect.width).attr("stroke-width", 0), L.attr("x1", (r) => r.state.rect.width).attr("x2", (r) => r.state.rect.width), D3.attr("y1", (r) => r.state.rect.height + c3(r) / 2).attr("y2", (r) => r.state.rect.height + c3(r) / 2), this.transition(D3).attr("x1", -1).attr("x2", (r) => r.state.rect.width + 2).attr("stroke", (r) => s2(r)).attr("stroke-width", c3);
    const ct = C3.selectAll(
      v2("circle")
    );
    this.transition(ct).attr("r", 0).attr("stroke-width", 0), N.attr("cx", (r) => r.state.rect.width).attr("cy", (r) => r.state.rect.height + c3(r) / 2), this.transition(N).attr("r", 6).attr("stroke-width", "1.5"), this.transition(P).style("opacity", 0), K2.attr("width", (r) => Math.max(0, r.state.rect.width - i * 2)).attr("height", (r) => r.state.rect.height), this.transition(K2).style("opacity", 1), this.transition(ot).attr("d", (r) => {
      const p = y3(r.target), f = [
        p.x + p.width,
        p.y + p.height + c3(r.target) / 2
      ];
      return A5({ source: f, target: f });
    }).attr("stroke-width", 0).remove(), this.transition(at).attr("stroke", (r) => s2(r.target)).attr("stroke-width", (r) => c3(r.target)).attr("d", (r) => {
      const p = r.source, f = r.target, E2 = [
        p.state.rect.x + p.state.rect.width,
        p.state.rect.y + p.state.rect.height + c3(p) / 2
      ], ht = [
        f.state.rect.x,
        f.state.rect.y + f.state.rect.height + c3(f) / 2
      ];
      return A5({ source: E2, target: ht });
    }), n && this.fit();
  }
  transition(t) {
  ...
  async fit(t = this.options.maxInitialScale) {
    const i = this.svg.node(), { width: n, height: s2 } = i.getBoundingClientRect(), { fitRatio: a2 } = this.options, { x1: c3, y1: o, x2: l, y2: h } = this.state.rect, d = l - c3, g = h - o, u4 = Math.min(
      n / d * a2,
      s2 / g * a2,
      t
    ), m = identity5.translate(
      (n - d * u4) / 2 - c3 * u4,
      (s2 - g * u4) / 2 - o * u4
    ).scale(u4);
  ...
  async ensureVisible(t, i) {
    ...
    if (!n) return;
    const s2 = this.svg.node(), a2 = s2.getBoundingClientRect(), c3 = transform(s2), [o, l] = [
      n.state.rect.x,
      n.state.rect.x + n.state.rect.width + 2
    ].map((b) => b * c3.k + c3.x), [h, d] = [
      n.state.rect.y,
      ...
      bottom: 0,
      ...i
    }, u4 = [g.left - o, a2.width - g.right - l], m = [g.top - h, a2.height - g.bottom - d], x3 = u4[0] * u4[1] > 0 ? U(u4, Math.abs) / c3.k : 0, y3 = m[0] * m[1] > 0 ? U(m, Math.abs) / c3.k : 0;
    if (x3 || y3) {
      const b = c3.translate(x3, y3);
  ...
  async centerNode(t, i) {
    ...
    if (!n) return;
    const s2 = this.svg.node(), a2 = s2.getBoundingClientRect(), c3 = transform(s2), o = (n.state.rect.x + n.state.rect.width / 2) * c3.k + c3.x, l = (n.state.rect.y + n.state.rect.height / 2) * c3.k + c3.y, h = {
      left: 0,
      right: 0,
      top: 0,
      bottom: 0,
      ...i
    }, d = (h.left + a2.width - h.right) / 2, g = (h.top + a2.height - h.bottom) / 2, u4 = (d - o) / c3.k, m = (g - l) / c3.k;
    if (u4 || m) {
      const y3 = c3.translate(u4, m);
   ...
   */
  async rescale(t) {
    const i = this.svg.node(), { width: n, height: s2 } = i.getBoundingClientRect(), a2 = n / 2, c3 = s2 / 2, o = transform(i), l = o.translate(
      (a2 - o.x) * (1 - t) / o.k,
      (c3 - o.y) * (1 - t) / o.k
    ).scale(t);
