...
var _promise = require("./promise.cjs");
...
var _throttleDebounce = require("./throttle-debounce.cjs");
Object.keys(_throttleDebounce).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _throttleDebounce[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _throttleDebounce[key];
    }
  });
});
