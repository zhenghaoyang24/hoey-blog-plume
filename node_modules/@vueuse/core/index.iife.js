(function (exports, shared, vue) {
  ...
  function useMediaControls(target, options = {}) {
    ...
    useEventListener(target, "timeupdate", () => ignoreCurrentTimeUpdates(() => currentTime.value = vue.toValue(target).currentTime));
    useEventListener(target, "durationchange", () => duration.value = vue.toValue(target).duration);
    useEventListener(target, "progress", () => buffered.value = timeRangeToArray(vue.toValue(target).buffered));
    ...
    useEventListener(target, "ratechange", () => rate.value = vue.toValue(target).playbackRate);
