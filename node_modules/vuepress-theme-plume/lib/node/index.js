...
import { colors as colors3, fs as fs6, hash as hash3, path as path9 } from "vuepress/utils";
...
import { entries as entries3, fromEntries as fromEntries2, getLocalePaths, inferRootLocalePath, isPlainObject as isPlainObject2 } from "@vuepress/helper";
...
import { entries as entries4, isBoolean, isPlainObject as isPlainObject3 } from "@vuepress/helper";
...
function enableBulletin(page, options) {
  let enablePage;
  if (isPlainObject5(options.bulletin) && options.bulletin.enablePage) {
    enablePage = options.bulletin.enablePage;
  } else if (options.locales) {
    for (const locale of Object.keys(options.locales)) {
      if (isPlainObject5(options.locales[locale].bulletin) && options.locales[locale].bulletin.enablePage) {
...
import { entries as entries5, isLinkAbsolute as isLinkAbsolute2, isLinkHttp, isPlainObject as isPlainObject8 } from "@vuepress/helper";
