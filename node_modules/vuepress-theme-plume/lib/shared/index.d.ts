import { PageFrontmatter, Page, LocaleData, LocaleConfig } from 'vuepress';
...
import { DocSearchPluginOptions, DocSearchOptions as DocSearchOptions$1 } from '@vuepress/plugin-docsearch';
import { CommentPluginOptions } from '@vuepress/plugin-comment';
import { CopyCodePluginOptions } from '@vuepress/plugin-copy-code';
import { ContributorsOptions, ChangelogOptions, GitPluginPageData } from '@vuepress/plugin-git';
export { GitChangelogInfo as GitChangelog, GitContributorInfo as GitContributor } from '@vuepress/plugin-git';
import { ReadingTimePluginOptions, ReadingTime } from '@vuepress/plugin-reading-time';
...
interface MarkdownOptions extends MarkdownPowerPluginOptions, Pick<MarkdownEnhancePluginOptions, 'chartjs' | 'echarts' | 'mermaid' | 'markmap' | 'plantuml' | 'flowchart' | 'revealJs' | 'playground' | 'vuePlayground' | 'kotlinPlayground' | 'sandpack'>, Pick<MarkdownHintPluginOptions, 'alert' | 'hint'> {
    /**
