...
import { LocaleData, LocaleConfig } from 'vuepress/core';
...
type PlumeThemeHomeConfig = PlumeThemeHomeBanner | PlumeThemeHomeTextImage | PlumeThemeHomeFeatures | PlumeThemeHomeProfile | PlumeThemeHomeHero;
...
interface PlumeThemeDocHero extends PlumeThemeHero {
    image?: ThemeImage;
}
...
interface PlumeThemeHomeDocHero extends PlumeHomeConfigBase {
    type: 'doc-hero';
...
export type { AutoFrontmatterArray, AutoFrontmatterMarkdownFile, AutoFrontmatterObject, AutoFrontmatterOptions, BlogOptions, BlogPostCoverLayout, BlogPostCoverStyle, BulletinOptions, CopyrightFrontmatter, CopyrightLicense, CopyrightOptions, EncryptOptions, FeatureIcon, FriendGroup, FriendsItem, FrontmatterFn, KnownCopyrightLicense, LastUpdatedOptions, LiteralUnion, NavItem, NavItemChildren, NavItemWithChildren, NavItemWithLink, NoteItem, NotesOptions, PageCategoryData, PlumeHomeConfigBase, PlumeThemeBlogPostData, PlumeThemeBlogPostItem, PlumeThemeData, PlumeThemeDocHero, PlumeThemeFriendsFrontmatter, PlumeThemeHero, PlumeThemeHeroAction, PlumeThemeHomeBanner, PlumeThemeHomeConfig, PlumeThemeHomeCustom, PlumeThemeHomeDocHero, PlumeThemeHomeFeature, PlumeThemeHomeFeatures, PlumeThemeHomeFrontmatter, PlumeThemeHomeHero, PlumeThemeHomeHeroTintPlate, PlumeThemeHomeProfile, PlumeThemeHomeTextImage, PlumeThemeLocaleData, PlumeThemeLocaleOptions, PlumeThemeOptions, PlumeThemePageData, PlumeThemePageFrontmatter, PlumeThemePluginOptions, PlumeThemePostFrontmatter, PresetLocale, ProfileOptions, ResolvedNavItem, ResolvedNavItemChildren, ResolvedNavItemWithChildren, ResolvedNavItemWithLink, ResolvedSidebar, ResolvedSidebarItem, ResolvedSidebarMulti, Sidebar, SidebarItem, SidebarMulti, SocialLink, SocialLinkIcon, SocialLinkIconUnion, ThemeColor, ThemeIcon, ThemeImage, ThemeOutline, TransitionOptions };
